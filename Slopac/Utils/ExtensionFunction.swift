...
extension UIViewController {
    func alert(message: String, title: String, buttonTitle: String) {
...
extension UISegmentedControl {
    func setIconLeft(_ image: UIImage, index: Int) {
        self.setImage(image, forSegmentAt: index)
        self.mask?.contentMode = .scaleAspectFit 
        self.tintColor = COLOR_THEME_WHITE
    }
}
...
extension UILabel{
    ...
    func customValidationPasswordLabel(){
        self.textColor = COLOR_THEME_GREY
        self.lineBreakMode =  .byWordWrapping
...
extension UIImageView {
    ...
    func loadPictureWithLoadingScreen(isbn: String, loadingView: UIView, loadingLabel: UILabel, spinner: UIActivityIndicatorView, actualView: UIView, navigationController: UINavigationController, text: String, actualViewController: UIViewController) {
                ...
                if let image = UIImage(data: data) {
                    DispatchQueue.main.async {
                        if(image.size.width == 1 && image.size.height == 1){
                            ...
                            actualViewController.alert(message: "alert_find_cover_message".localized, title: "alert_find_cover_title".localized, buttonTitle: "alert_find_cover_button".localized)
